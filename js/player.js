...
console.log("SESSION PLAYER NAME IS: ", playerName);
  ...
  docRef.get().then(function(doc) {
    if (doc.exists) {
      ...
      //header
      var banner = '<header style="position: relative; height: 450px; background: linear-gradient(30deg, #004092, transparent, transparent), url(' + doc.data().bannerImage + ');   background-size: cover; "><div class="row"><div class="col s4"><h3 class="white-text" style="margin-left: 25%;">' + doc.data().twitch + '</h3><h6 class="white-text" style="margin-left: 25%;">'+doc.data().miniBio+'</h6><hr color="white" /><div class="row" style="margin-left: 25%;"><div class="col s6"><h6 class="white-text">' + doc.data().squad + ' in Community</h6></div></div><div class="row" style="margin-left: 25%;"><div class="col s3"><a href="'+doc.data().instagram+'"><img width="50%" src="https://cdn2.iconfinder.com/data/icons/instagram-new/512/instagram-logo-color-512.png"></img></a></div><div class="col s3 "><a href="'+doc.data().twitter+'"><img width="50%" src="http://www.stickpng.com/assets/images/580b57fcd9996e24bc43c53e.png"></img></a></div><div class="col s3 "><a href="'+doc.data().youtube+'"><img width="50%" src="https://images.vexels.com/media/users/3/137425/isolated/preview/f2ea1ded4d037633f687ee389a571086-youtube-icon-logo-by-vexels.png"></img></a></div><div class="col s3"><a class="waves-effect waves-light btn white black-text" style="margin-left: 25%; border-radius: 20px;">Join Squad</a></div></div></div><div class="col s3 push-s1"><!-- Twitch Live Stream --><div id="twitch-embed" style="margin-top: 5%;"></div></div><div class="row s6 right-align"><iframe frameborder="0" scrolling="no" id="chat_embed" src="https://www.twitch.tv/embed/'+doc.data().twitch+'/chat" height="400" width="300" style="margin-top: 1%; margin-right: 1%;"></iframe></div></div></header>';
      ...
      var twitch1 = '<iframe src="https://clips.twitch.tv/embed?clip=' + doc.data().twitchClip1 + '" width="400" height="360" frameborder="0" scrolling="no" allowfullscreen="true" autoplay="false"> </iframe>';
      var twitch2 = '<iframe src="https://clips.twitch.tv/embed?clip=' + doc.data().twitchClip2 + '" width="400" height="360" frameborder="0" scrolling="no" allowfullscreen="true" autoplay="false"> </iframe>';
      var twitch3 = '<iframe src="https://clips.twitch.tv/embed?clip=' + doc.data().twitchClip3 + '" width="400" height="360" frameborder="0" scrolling="no" allowfullscreen="true" autoplay="false"> </iframe>';
